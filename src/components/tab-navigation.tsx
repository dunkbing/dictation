...
function SortableTab({ tab, isActive, onSwitch, onClose, showClose }: SortableTabProps) {
  ...
  return (
    ...
    >
      ...
      <span className="text-sm truncate flex-1 cursor-pointer" onClick={() => onSwitch(tab.path)}>
        {tab.name}
      </span>
      {showClose && (
        <button
