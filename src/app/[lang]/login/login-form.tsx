...
export default function LoginForm({ dict, lang }: { dict: Dictionary; lang: Locale }) {
  ...
  const form = useForm({
    ...
    onSubmit: async ({ value }) => {
      ...
      const res = await apiClient.auth.login.$post({ json: value });
      if (!res.ok) {
        ...
        >
          ...
          <CardFooter className="flex flex-col space-y-4 mt-4">
            ...
            <p className="text-center text-sm text-muted-foreground">
              ...
              <Link href={`/${lang}/register`} className="font-semibold hover:underline">
